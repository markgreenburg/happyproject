/**
 * Created by codytaylor on 1/8/17.
 */
/*
...
(function (e, t) {
    ...
    function w(t, n, i, s) {
        var o = b(t.href, e.location.href), u = o.url, a = l && l.getItem(u), f = l && l.getItem(u + ":timestamp"), c = {
            css: a,
            timestamp: f
        }, h, p = {relativeUrls: r.relativeUrls, currentDirectory: o.path, filename: u};
    ...
    (function (r) {
        ...
        r.functions = {
            rgb: function (e, t, n) {
                ...
                var o = [n, n * (1 - t), n * (1 - s * t), n * (1 - (1 - s) * t)], u = [[0, 3, 1], [2, 0, 1], [1, 0, 3], [1, 2, 0], [3, 1, 0], [0, 1, 2]];
                ...
                if (typeof e == "number" && typeof t == "number") e = new r.Dimension(e), t = new r.Dimension(t); else if (!(e instanceof r.Dimension) || !(t instanceof r.Dimension))throw{
                    type: "Argument",
        ...
        var i = [{name: "ceil"}, {name: "floor"}, {name: "sqrt"}, {name: "abs"}, {name: "tan", unit: ""}, {
            name: "sin",
            unit: ""
        ...
        e.Assignment = function (e, t) {
            ...
            type: "Assignment", accept: function (e) {
                this.value = e.visit(this.value)
            }, toCSS: function () {
        ...
        e.Condition = function (e, t, n, r, i) {
            ...
            type: "Condition", accept: function (e) {
        ...
        e.Dimension = function (n, r) {
            ...
            type: "Dimension", accept: function (e) {
            ...
            length: {m: 1, cm: .01, mm: .001, "in": .0254, pt: .0254 / 72, pc: .0254 / 72 * 12},
            duration: {s: 1, ms: .001},
        ...
        e.Directive = function (t, n) {
            ...
            type: "Directive", accept: function (e) {
        ...
        e.Element = function (t, n, r) {
            ...
            type: "Element", accept: function (e) {
            ...
            type: "Attribute", accept: function (e) {
                this.value = e.visit(this.value)
            }, eval: function (t) {
            ...
            type: "Combinator", toCSS: function (e) {
                return {
                    "": "",
                    " ": " ",
                    ":": " :",
        ...
        e.Expression = function (e) {
            ...
            type: "Expression", accept: function (e) {
                this.value = e.visit(this.value)
            }, eval: function (t) {
        ...
        e.JavaScript = function (e, t, n) {
            ...
            type: "JavaScript", eval: function (t) {
        ...
        e.mixin = {}, e.mixin.Call = function (t, n, r, i, s) {
            ...
            type: "MixinCall", accept: function (e) {
            ...
            type: "MixinDefinition", accept: function (e) {
        ...
        e.Negative = function (e) {
            ...
            type: "Negative", accept: function (e) {
                this.value = e.visit(this.value)
            }, toCSS: function (e) {
        ...
        e.Operation = function (e, t, n) {
            ...
            type: "Operation", accept: function (e) {
        ...
        e.Ruleset = function (e, t, n) {
            ...
            type: "Ruleset", accept: function (e) {
        ...
        e.Selector = function (e, t) {
            ...
            type: "Selector", accept: function (e) {
        ...
        e.UnicodeDescriptor = function (e) {
            ...
            type: "UnicodeDescriptor", toCSS: function (e) {
                return this.value
            }, eval: function () {
                return this
            }
